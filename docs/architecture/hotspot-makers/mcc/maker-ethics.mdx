...
The community may raise ethics violation issues and send evidence to the MCC via the Helium Foundation: [hello@helium.foundation](mailto:hello@helium.foundation)
...
- Product information including:
  - Model name
  - Countries serviced
  - What token(s) the product can earn
